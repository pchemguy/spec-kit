...
The Spec Kit framework project produces **framework artifacts**: agent prompts, templates, command scaffolds, workflow guidance, and related generative assets. These artifacts are the primary development objects and deliverables of Spec Kit framework project.

By contrast, downstream **project artifacts** - such as a materialized constitution, specification, implementation plan, task list, checklist, issue mapping, or similar delivery document - are expected outputs of downstream projects that use Spec Kit framework as a tool. Project artifacts are the immediate working documents used to define, decompose, and deliver a specific feature. Framework artifacts operate at a higher level: in context of downstream projects, framework artifacts are not themselves normal deliverables, but they strongly shape the form, quality, and behavior of the project artifacts produced from them.
